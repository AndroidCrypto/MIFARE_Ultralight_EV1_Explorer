...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String messageTrue = "Although a MIFARE Ultralight EV1 is very similar to an Ultralight or an Ultralight C tag, you should use this app with an Ultralight EV1 tag only.";
    ...
    private void displayLicensesAlertDialog() {
        ...
        mAlertDialog = new android.app.AlertDialog.Builder(getContext(), R.style.Theme_MIFARE_Ultralight_C_Examples)
